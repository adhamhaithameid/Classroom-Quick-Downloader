...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    after_posting: 'después de publicar',
    modified: 'Modificado',
  },
  hi: {
    download: 'डाउनलोड',
    ...
    after_posting: 'पोस्ट करने के बाद',
    modified: 'संशोधित',
  },
  pt: {
    download: 'Baixar',
  ...
  fr: {
    ...
    after_posting: 'après la publication',
    modified: 'Modifié',
  },
  de: {
  ...
  it: {
    ...
    after_posting: 'dopo la pubblicazione',
    modified: 'Modificato',
  },
  ru: {
    download: 'Скачать',
    ...
    after_posting: 'после публикации',
    modified: 'Изменено',
  },
  ko: {
    download: '다운로드',
  ...
  tr: {
    ...
    after_posting: 'yayınlandıktan sonra',
  ...
  id: {
    ...
    after_posting: 'setelah memposting',
    modified: 'Diubah',
  },
  th: {
    download: 'ดาวน์โหลด',
  ...
  pl: {
    ...
    after_posting: 'po opublikowaniu',
  ...
  ta: {
    ...
    editedTooltip: 'பதிவிடுவதற்கும் கடைசித் திருத்தத்திற்கும் இடைப்பட்ட நாட்கள்',
  ...
  uk: {
    ...
    file: 'файл',
    files: 'файлів',
    commentsTooltip: 'Кількість коментарів до цієї записи',
    ...
    cancelled: 'Отменено',
    cancelAll: 'Отменить все',
    after_posting: 'після публікації',
    modified: 'Змінено',
  },
  el: {
    download: 'Λήψη',
  ...
  jw: { // Javanese
    ...
    commError: 'Kesalahan komunikasi.',
    editedTooltip: 'Dina antarane posting lan suntingan pungkasan',
    modified: 'Diowahi',
    after_posting: 'bubar posting',
    cancel: 'Batal',
    cancelled: 'Dibatalké',
    cancelAll: 'Batal Kabeh',
  },
  mg: {
    download: 'Ampidino',
  ...
  kri: { // Krio
    download: 'Dɔnlod',
    downloading: 'De dɔnlod…',
    trying: 'De tray…',
    downloaded: 'Dɔn dɔnlod',
    error: 'Erɔ',
    failed: 'Dɔnlod nɔ wok.',
    ariaDownload: 'Dɔnlod',
    titleQuick: 'Kwik dɔnlod',
    comments: 'kɔmɛnt dɛn',
    commentSingular: 'kɔmɛnt',
    edited: 'Dɔn edit',
    downloadAll: 'Dɔnlod ɔl',
    file: 'fayl',
    files: 'fayl dɛn',
    commentsTooltip: 'Nɔmba fɔ kɔmɛnt dɛn pan dis post',
    editedTooltip: 'Dez bitwin postin ɛn di las edit',
    downloadInterrupted: 'Dɔnlod dɔn kɔt.',
    runtimeError: 'Rɔntaym nɔ de',
    startError: 'Nɔ ebul stat.',
    commError: 'Kɔmyunikeshɔn erɔ.',
    modified: 'Chenj',
    after_posting: 'afta postin',
    cancel: 'Kansul',
    cancelled: 'Dɔn kansul',
    cancelAll: 'Kansul Ɔl',
  },
  ln: { // Lingala
    download: 'Kokitisa',
  ...
  lua: { // Luba-Lulua
    download: 'Kupakula',
    downloading: 'Kupakula…',
    trying: 'Kukeba…',
    downloaded: 'Kupakulwa',
    error: 'Mupika',
    failed: 'Kupakula kubulwa.',
    ariaDownload: 'Kupakula',
    titleQuick: 'Kupakula lukasa',
    comments: 'maluwi',
    commentSingular: 'diluwi',
    edited: 'Kulongolola',
    downloadAll: 'Kupakula yonso',
    file: 'fayile',
    files: 'mifayile',
    commentsTooltip: 'Nomba ya maluwi pa post eyi',
    editedTooltip: 'Minsu ya katshi ka post ne edit wa ndekelu',
    downloadInterrupted: 'Kupakula kudi kupingana.',
    runtimeError: 'Runtime kadiyi kudi',
    startError: 'Kadiyi kukonkonona.',
    commError: 'Mupika wa kuakula.',
    modified: 'Kulongolola',
    after_posting: 'pashishe pa post',
    cancel: 'Kulekela',
    cancelled: 'Kulekelwa',
    cancelAll: 'Kulekela Yonso',
  },
  ...
  nyn: { // Runyankore
    download: 'Kurukura',
    downloading: 'Nkurukura…',
    trying: 'Ngerageza…',
    downloaded: 'Nkurukurwa',
    error: 'Enshobi',
    failed: 'Yagwisa.',
    ariaDownload: 'Kurukura',
    titleQuick: 'Kurukura mangu',
    comments: 'ebiteekateeko',
    commentSingular: 'ekiteekateeko',
    edited: 'Yakyebemberwa',
    downloadAll: 'Kurukura byona',
    file: 'fayiro',
    files: 'enfayiro',
    commentsTooltip: 'Omuwendo gw\'ebiteekateeko aha post egi',
    editedTooltip: 'Ebiro aha kakati k\'okupostinga n\'okukyebembera kwekyehererukira',
    downloadInterrupted: 'Okurukura kwahagarara.',
    runtimeError: 'Runtime tikyariho',
    startError: 'Tikyasobora kutandika.',
    commError: 'Enshobi y\'okukwatagana.',
    modified: 'Yakyebemberwa',
    after_posting: 'bwanyima y\'okupostinga',
    cancel: 'Hagarika',
    cancelled: 'Kyahagarikwa',
    cancelAll: 'Hagarika Byona',
  },
  om: { // Oromo
    download: 'Buusi',
  ...
  pcm: { // Nigerian Pidgin
    ...
    failed: 'E no work.',
    ariaDownload: 'Download',
    titleQuick: 'Sharp download',
    comments: 'komments',
    commentSingular: 'komment',
    edited: 'Dem don edit am',
    downloadAll: 'Download evritin',
    file: 'file',
    files: 'files',
    commentsTooltip: 'How many comments dey for dis post',
    editedTooltip: 'Days wey pass between postin and last edit',
    downloadInterrupted: 'Download cut.',
    runtimeError: 'Runtime no dey',
    startError: 'E no fit start.',
    commError: 'Wahala for connection.',
    modified: 'Wetin dem change',
    after_posting: 'after posting',
    cancel: 'Kansul',
    cancelled: 'Don kansul',
    cancelAll: 'Kansul Evritin',
  },
  rw: { // Kinyarwanda
    download: 'Kuramo',
  ...
  crs: { // Seselwa Creole French
    ...
    editedTooltip: 'Zour ant posting ek dernyen modifikasyon',
  ...
  tum: { // Tumbuka
    ...
    files: 'files',
    commentsTooltip: 'Number of comments on this post',
    editedTooltip: 'Mazuŵa pakati pa kuika na kusintha kwaumaliro',
    downloadInterrupted: 'Download yadukizgika.',
    runtimeError: 'Runtime palije',
    startError: 'Yatondeka kwamba.',
    commError: 'Communication error.',
    modified: 'Kusinthidwa',
    after_posting: 'pamanyuma pakuika',
    cancel: 'Kanizga',
    cancelled: 'Yakanizgika',
    cancelAll: 'Kanizga Yose',
  },
  wo: { // Wolof
    download: 'Yeb',
  ...
  nn: { // Norwegian Nynorsk
    ...
    commError: 'Kommunikasjonsfeil.',
    modified: 'Endra',
    after_posting: 'etter publisering',
    cancel: 'Avbryt',
    cancelled: 'Avbroten',
    cancelAll: 'Avbryt alt',
  },
  oc: { // Occitan
    download: 'Telecargar',
  ...
  mfe: { // Mauritian Creole
    ...
    editedTooltip: 'Zour ant poste ek dernie modifikasion',
    downloadInterrupted: 'Download finn aret.',
    runtimeError: 'Runtime pa disponib',
  ...
  eo: { // Esperanto
    ...
    edited: 'Redaktita',
    downloadAll: 'Elŝuti ĉiujn',
    file: 'dosiero',
    files: 'dosieroj',
    commentsTooltip: 'Nombro da komentoj pri ĉi tiu afiŝo',
    editedTooltip: 'Tagoj inter afiŝado kaj la lasta redakto',
    downloadInterrupted: 'Elŝuto interrompita.',
    runtimeError: 'Rultempo ne disponebla',
    startError: 'Ne eblis komenci.',
    commError: 'Komunika eraro.',
    modified: 'Modifita',
    after_posting: 'post afiŝado',
    cancel: 'Nuligi',
    cancelled: 'Nuligita',
    cancelAll: 'Nuligi Ĉiujn',
  },
};
