...
const EDGE_CASES: EdgeCase[] = [
  ...
  {
    name: 'invalid suspicious encoding docs traversal 7',
    url: 'https://docs.google.com/document/d/1enc7/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 8',
    url: 'https://docs.google.com/document/d/1enc8/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 9',
    url: 'https://docs.google.com/document/d/1enc9/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 10',
    url: 'https://docs.google.com/document/d/1enc10/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 11',
    url: 'https://docs.google.com/document/d/1enc11/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 12',
    url: 'https://docs.google.com/document/d/1enc12/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 13',
    url: 'https://docs.google.com/document/d/1enc13/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 14',
    url: 'https://docs.google.com/document/d/1enc14/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 15',
    url: 'https://docs.google.com/document/d/1enc15/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 16',
    url: 'https://docs.google.com/document/d/1enc16/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 17',
    url: 'https://docs.google.com/document/d/1enc17/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 18',
    url: 'https://docs.google.com/document/d/1enc18/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid suspicious encoding docs traversal 19',
    url: 'https://docs.google.com/document/d/1enc19/..%252fsecret/export?format=pdf',
    expectedValid: false,
    expectedReasonContains: 'SUSPICIOUS_ENCODING',
  },
  {
    name: 'invalid userinfo spoof drive 0',
    url: 'https://attacker0.example@drive.google.com/file/d/1spoof0/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 1',
    url: 'https://attacker1.example@drive.google.com/file/d/1spoof1/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 2',
    url: 'https://attacker2.example@drive.google.com/file/d/1spoof2/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 3',
    url: 'https://attacker3.example@drive.google.com/file/d/1spoof3/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 4',
    url: 'https://attacker4.example@drive.google.com/file/d/1spoof4/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 5',
    url: 'https://attacker5.example@drive.google.com/file/d/1spoof5/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
  ...
  {
    name: 'invalid userinfo spoof drive 7',
    url: 'https://attacker7.example@drive.google.com/file/d/1spoof7/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 8',
    url: 'https://attacker8.example@drive.google.com/file/d/1spoof8/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 9',
    url: 'https://attacker9.example@drive.google.com/file/d/1spoof9/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 10',
    url: 'https://attacker10.example@drive.google.com/file/d/1spoof10/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 11',
    url: 'https://attacker11.example@drive.google.com/file/d/1spoof11/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 12',
    url: 'https://attacker12.example@drive.google.com/file/d/1spoof12/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 13',
    url: 'https://attacker13.example@drive.google.com/file/d/1spoof13/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 14',
    url: 'https://attacker14.example@drive.google.com/file/d/1spoof14/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 15',
    url: 'https://attacker15.example@drive.google.com/file/d/1spoof15/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 16',
    url: 'https://attacker16.example@drive.google.com/file/d/1spoof16/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 17',
    url: 'https://attacker17.example@drive.google.com/file/d/1spoof17/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 18',
    url: 'https://attacker18.example@drive.google.com/file/d/1spoof18/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
  {
    name: 'invalid userinfo spoof drive 19',
    url: 'https://attacker19.example@drive.google.com/file/d/1spoof19/view',
    expectedValid: false,
    expectedReasonContains: 'UNEXPECTED_URL_SHAPE',
  },
];
