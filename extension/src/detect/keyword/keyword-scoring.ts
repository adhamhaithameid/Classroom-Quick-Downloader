...
/**
 * Exported so KeywordDetector can build a PostObservation from the layer
 * results without re-deriving their shape.
 */
export type { CommentLayerResult, EditedLayerResult };

/**
 * Re-exported so KeywordDetector needs no keyword-loader or exclusion-engine
