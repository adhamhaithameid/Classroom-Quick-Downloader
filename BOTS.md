...
| **Google Jules** | **AI Maintenance Agents**<br>Runs scheduled owner-controlled agents that create focused PRs, Issues, or no-op reports for extension, Worker, Oracle, website, docs, tests, and planning work. | • `agents/jules/`<br>• `.jules/` |

## Google Jules Agent Schedule

Jules is configured in the Jules web app. The repository stores public-safe prompt copies and operating docs in `agents/jules/`.
...
- Prompt bodies are stored in `agents/jules/prompts/`.
