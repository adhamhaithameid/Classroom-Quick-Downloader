var content=(function(){"use strict";function fe(e){return e}const L=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
...
</svg>`,Z=`<svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`,J=`<svg fill="none" height="160" viewBox="0 0 160 160" width="160" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`,S=`data:image/svg+xml;utf8,${encodeURIComponent(L)}`,O=`data:image/svg+xml;utf8,${encodeURIComponent(Z)}`,B=`data:image/svg+xml;utf8,${encodeURIComponent(J)}`,E="cqd-style",C=16,z="150ms cubic-bezier(0.2, 0, 0, 1)";function U(){if(typeof document>"u"||document.getElementById(E))return;const e=document.createElement("style");e.id=E,e.textContent=`
    :root {
      --cqd-transition: ${z};
