var downloadall = (function() {
  ...
  function handleDownloadAllClick(group) {
    ...
    for (const file of group.files.values()) {
      for (const btn2 of file.buttons) {
        if (!btn2.isConnected) continue;
        const s = getSingleButtonState(btn2);
        if (s === "idle" || s === "error") {
          btn2.click();
          break;
        }
