var downloadall = (function() {
  ...
  function findHeaderContainer(root) {
    const n5dsp = root.querySelector(".N5dSp");
    if (n5dsp) return n5dsp;
    const internalHeader = root.querySelector(".JZicYb.gmNu1d") || root.querySelector(".JZicYb");
  ...
  function placeDownloadButtonForPostView(button, headerContainer) {
    const searchRoot = headerContainer;
    const threeDots = searchRoot.querySelector(
    ...
    ) || searchRoot.querySelector(".pYTkkf-Bz112c-LgbsSe");
    if (threeDots && threeDots !== button) {
      const dotsParent = threeDots.parentElement;
      if (dotsParent) {
        let rightWrapper = dotsParent.querySelector(
  ...
  function placeDownloadButtonForStreamView(button, targetContainer) {
    const threeDots = targetContainer.querySelector(
      'div[role="button"][aria-haspopup="true"]'
    ) || targetContainer.querySelector(
      'div[role="button"][aria-label*="options"]'
    ) || targetContainer.querySelector(
      'div[role="button"][aria-label*="menu"]'
    ) || targetContainer.querySelector(".pYTkkf-Bz112c-LgbsSe");
    if (threeDots && threeDots !== button && threeDots.parentNode === targetContainer) {
