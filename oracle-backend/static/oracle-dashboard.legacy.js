      ...
      function renderExtChangelogEntriesTable(entries, container) {
        ...
        entries.forEach(function(entry) {
          ...
          html += '<td class="ext-cl-entry-date">' + escapeHtml(entry.date || '') + '</td>';
          html += '<td class="ext-cl-entry-summary">' + escapeHtml((entry.summary || '').slice(0, 100)) + '</td>';
          html += '<td class="ext-cl-cell-center ext-cl-count-added">' + (addedCount || '—') + '</td>';
          html += '<td class="ext-cl-cell-center ext-cl-count-changed">' + (changedCount || '—') + '</td>';
          html += '<td class="ext-cl-cell-center ext-cl-count-fixed">' + (fixedCount || '—') + '</td>';
          html += '<td class="ext-cl-cell-center">' + (entry.isImportant ? '⭐' : '') + '</td>';
