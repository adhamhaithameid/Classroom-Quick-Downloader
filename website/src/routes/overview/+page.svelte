      ...
      <div class="l2-ps-feature">
        ...
        <div class="l2-ps-pair">
          <div class="l2-ps-media-card l2-ps-problem">
            <div class="l2-ps-media-badge">Without Classroom Quick Downloader</div>
            <div class="l2-ps-media-wrap">
              <img class="l2-ps-img" src="{base}/images/problem-flags.png" alt="Classroom posts without edit/comment flags" loading="lazy" decoding="async" />
...
<style>
  ...
  /* CTA — flanking the call-to-action */
  .l2-doodle-cta-1 {
    width: 56px;
    height: 56px;
    top: -20px;
  ...
  .l2-doodle-cta-2 {
    ...
    bottom: -12px;
    right: -20px;
    animation: doodle-float 10s ease-in-out infinite reverse;
  }

  /* Silly — tucked into top-right of the question area */
  .l2-doodle-silly {
    width: 50px;
    height: 50px;
    top: -8px;
  ...
  /* Hero — cascading files (left) + browser window (right) */
  .l2-doodle-hero-1 {
    width: 72px;
    height: 72px;
    top: 18%;
    left: 2%;
    animation: doodle-float 10s ease-in-out infinite;
  }
  ...
  /* Features — privacy shield (top-left) + git branch (bottom-right) */
  .l2-doodle-features-1 {
    width: 60px;
    height: 60px;
    top: 4px;
    left: -12px;
  ...
  .l2-doodle-features-2 {
    width: 52px;
    height: 52px;
    bottom: 12px;
    right: -8px;
    animation: doodle-float 11s ease-in-out infinite reverse;
  }

  /* Steps — cursor with click ripple (top-right) */
  .l2-doodle-steps-1 {
    width: 56px;
    height: 56px;
    top: 0;
  ...
  /* Students — notebook with pencil (bottom-left) */
  .l2-doodle-students-1 {
    width: 64px;
    height: 64px;
    bottom: 8px;
    left: -8px;
  ...
  /* Solution — messy papers (top-right) + organized folder (bottom-left) */
  .l2-doodle-solution-1 {
    width: 64px;
    height: 64px;
    top: 4px;
    right: -8px;
  ...
  /* Proof — star trophy badge (top-right) */
  .l2-doodle-proof-1 {
    width: 60px;
    height: 60px;
    top: 0;
