...
<svelte:head>
  <!-- Visual identity guard: keep this Plus Jakarta preload so typography
       cannot drift without explicit test updates and review. -->
    ...
    <div class="l2-wrap l2-hero-content">
      ...
      <div class="l2-hero-actions">
        {#each orderedBrowserCtas as b}
          ...
          >
            <img src="{base}/images/{b}.svg" alt="" class="l2-cta-icon" width="22" height="22" loading="eager" decoding="async" />
                ...
                <div class="l2-silly-result l2-silly-waiting" transition:scale={{ duration: 400, start: 0.3 }}>
                  ...
                  {#if noShowCta}
                    <div class="l2-silly-cta-reveal" transition:scale={{ duration: 300, start: 0.7 }}>
                      ...
                      >
                        <img src="{base}/images/{detectedBrowser}.svg" alt="" class="l2-cta-icon" width="22" height="22" loading="lazy" decoding="async" />
    ...
    <div class="l2-wrap l2-cta-content l2-reveal" data-placement-section="cta" style="position:relative;overflow:visible">
      ...
      <div class="l2-hero-actions">
        {#each orderedBrowserCtas as b}
          ...
          >
            <img src="{base}/images/{b}.svg" alt="" class="l2-cta-icon" width="22" height="22" loading="lazy" decoding="async" />
            {#if b === detectedBrowser}Install for {browserDisplayName(b)}{:else}{browserDisplayName(b)}{/if}
          </a>
        {/each}
      </div>
