  ...
  <div class="hero-inner">
    ...
    <div class="hero-right">
      <div class="stat-card">
        ...
        <strong class="stat-number"><AnimatedNumber value={overview?.totals.downloads ?? 0} animated /></strong>
...
{:else}
  ...
  <section class="section-wide reveal">
    <div class="section-title-row">
      ...
      <span class="section-sub">Students and teachers using CQD in <AnimatedNumber value={countryCount} animated /> countries</span>
    </div>
